 ...
 */
package br.com.company.verizon.core.models;
...
import br.com.company.verizon.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "verizon/components/helloworld");
